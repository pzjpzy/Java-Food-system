 ...
 * @author pangz
 */
public class NotificationM extends javax.swing.JPanel {
    
    JFrame frame;
    private DefaultTableModel container = new DefaultTableModel();
    private String ColumnName[] = {""};
    
    public NotificationM(JFrame frame) {   
        initComponents();
    ...
    private void jButton4MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseReleased
        NotificationMH panel = new NotificationMH(frame);   //the panel you want to switch to
        frame.remove(this);
        frame.add(panel);
        frame.revalidate();
        frame.repaint();
