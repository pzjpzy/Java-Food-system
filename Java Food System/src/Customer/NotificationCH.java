 ...
 * @author pangz
 */
public class NotificationCH extends javax.swing.JPanel {
    
    JFrame frame;
    private DefaultTableModel container = new DefaultTableModel();
    private String ColumnName[] = {""};
    
    public NotificationCH(JFrame frame) {   
        initComponents();
    ...
    private void jButton3MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseReleased
        NotificationC panel = new NotificationC(frame);   //the panel you want to switch to
        frame.remove(this);
        frame.add(panel);
        frame.revalidate();
        frame.repaint();
